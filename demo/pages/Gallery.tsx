    ...
    <div style={s.root}>
      <div style={s.container}>
        <header style={s.header}>
          ...
          <div style={s.kpis}>
            <Kpi c={c} label="Primitives" value="11" hint="Canvas · Slice · Region · Device · Bg · Shape · Card · Title · Subtitle · Eyebrow · Highlight" />
            <Kpi c={c} label="Story" value="Hook · Shift · Proof · Delivery · Payoff" />
            <Kpi c={c} label="Rule" value="Text is the argument. UI is the proof." />
          </div>
        </header>
